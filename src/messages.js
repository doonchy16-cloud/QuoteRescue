...
function closeLoopVoicemail(input){const callback=input.callbackPhone?` You can call me at ${input.callbackPhone}.`:' You can call me back if you want to revisit it.';return `Hi ${input.customerName}, this is ${identity(input)}. I don’t want to over-follow up on the ${input.trade} estimate. Please let me know whether you’d like me to keep it open, reconnect later, or close it out for now.${callback} Thanks.`;}
